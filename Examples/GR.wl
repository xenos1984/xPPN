...
(* ::Text:: *)
(*The only constant parameter we need to define is the gravitational constant.*)
...
(* ::Text:: *)
(*This tensor will hold the gravitational field equations.*)
...
(* ::Text:: *)
(*Here we define the trace-reversed Einstein equations. These are more convenient to solve, since the time-time component contains only derivatives of the time-time component of the metric, and so the equations decouple immediately.*)
